...
export function renderBoard(state) {
  ...
  palaceClip.appendChild(svg("circle", { cx: 450, cy: 450, r: 71 }));
  ...
  finish.appendChild(palacePortrait);
  ...
  const startText = svg("text", { x: start.x, y: start.y + 4, "text-anchor": "middle", fill: "#fff", "font-size": 11, "font-weight": 900, "letter-spacing": ".05em", "dominant-baseline": "middle" });
  startText.textContent = "Départ";
  startDecoration.appendChild(startText);
