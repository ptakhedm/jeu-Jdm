...
export const classCatalog = [
  { name: "6ème 1", color: "#e15a4f" }, { name: "6ème 2", color: "#4e92ca" },
  { name: "6ème 3", color: "#55a66f" }, { name: "6ème 4", color: "#e7a13b" },
  { name: "6ème 5", color: "#9766bc" }
];
export const classProgression = Object.fromEntries(classCatalog.map(item => [item.name, { position: 0, rounds: 0 }]));
